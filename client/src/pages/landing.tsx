    ...
    scoreItems: [
      {
        ...
        description: "5 anos • Tecnologia",
        score: "9.2/10",
        icon: "check" as const,
      },
      {
        title: "Formação Acadêmica",
        description: "Ciência da Computação • USP",
        score: "8.8/10",
        icon: "check" as const,
      },
      {
        title: "Habilidades Técnicas",
        description: "Melhore suas habilidades em Python",
        score: "7.5/10",
        icon: "exclamation" as const,
      },
      {
        title: "Idiomas",
        description: "Português, Inglês Avançado",
        score: "9.0/10",
        icon: "check" as const,
      },
    ],
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection>
            <div className="text-center">
              ...
              >
                Transforme seu <span className="text-blue-500">Currículo</span>
                <br />
              ...
              >
                Descubra como melhorar seu currículo com análises detalhadas e
                sugestões personalizadas. Nossa IA identifica pontos fortes e
                oportunidades de melhoria em segundos.
              </motion.p>
          ...
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Nossa inteligência artificial avalia cada aspecto do seu
                currículo, oferecendo insights precisos para maximizar suas
                chances de sucesso.
              </p>
            </div>
          </AnimatedSection>
            ...
            {[
              {
                ...
                description:
                  "IA avançada que analisa estrutura, conteúdo, palavras-chave e adequação às vagas desejadas.",
              ...
              },
              {
                ...
                description:
                  "Receba dicas específicas e acionáveis para melhorar cada seção do seu currículo.",
              ...
              },
              {
                ...
                description:
                  "Análise completa em menos de 30 segundos. Otimize seu currículo instantaneamente.",
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Em apenas 3 passos simples, você terá um currículo otimizado e
            ...
            {[
              {
                ...
                description:
                  "Faça upload do seu currículo em PDF ou Word. Processo seguro e confidencial.",
                color: "bg-blue-500",
              },
              {
                step: 2,
                ...
                description:
                  "Nossa IA analisa cada aspecto: formato, conteúdo, palavras-chave e estrutura.",
                color: "bg-green-500",
              },
              {
                step: 3,
                ...
                description:
                  "Relatório detalhado com pontuação, sugestões específicas e melhorias recomendadas.",
                color: "bg-purple-500",
              },
            ].map((step, index) => (
              <AnimatedSection key={index} delay={index * 0.1}>
                <div className="text-center">
                  <div
                    className={`w-20 h-20 ${step.color} rounded-full flex items-center justify-center mx-auto mb-6 apple-shadow-lg`}
                  >
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Comece gratuitamente e desbloqueie todo o potencial com nossos
                planos premium.
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <AnimatedSection key={index} delay={index * 0.1}>
                <Card
                  className={`rounded-3xl p-8 apple-shadow hover-lift relative ${
                ...
                >
                  ...
                  <div className="text-center mb-8">
                    <h3
                      className={`text-2xl font-bold mb-4 ${plan.popular ? "text-white" : "text-slate-900"}`}
                    >
                      {plan.name}
                    </h3>
                    <div
                      className={`text-4xl font-bold mb-2 ${plan.popular ? "text-white" : "text-slate-900"}`}
                    >
                      {plan.price}
                    </div>
                    <div
        ...
        <div className="max-w-4xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Junte-se a milhares de profissionais que já melhoraram seus
              currículos com nossa IA. Comece hoje mesmo!
            </p>
            <Button
              onClick={() => setShowLoginModal(true)}
              size="lg"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-white/70 mb-4 max-w-md">
                Transforme seu currículo com inteligência artificial e conquiste
          ...
          <div className="border-t border-white/20 mt-12 pt-8 text-center">
            <p className="text-white/70">
              &copy; 2024 cvintelligence. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
